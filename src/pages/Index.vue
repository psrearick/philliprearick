  ...
  <Layout>
    <div class="md:flex gap-8">
      <div class="flex-1">
        ...
        <div class="flex flex-col gap-8 mb-8">
          <div v-for="(post, index) in posts" :key="index">
            <g-link :to="post.path">
                <g-image :alt="post.image.alt" :src="post.image.path" class="mb-2 h-64 object-cover rounded-md" />
            </g-link>
            <div class="pb-4">
                <div class="flex-1">
                    <g-link :to="post.path" class="text-xl flex-1">{{ post.title }}</g-link>
                </div>
                <div>
      ...
      <div class="md:w-1/3 mt-8 md:mt-0">
        ...
        <p>
          I am a software developer, blogger, and stock trader in Columbus, Ohio.
          While I do not have a formal education in finance, personal finance is a topic that I have extensively researched.
          I love digging into the numbers and learning new strategies for optimizing my finances.
